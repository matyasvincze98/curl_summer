...
'''pickle.dump('fakelabeled_natural_commonfiltered_640000_40px.pkl', 
            open('fakelabeled_natural_commonfiltered_640000_40px.pkl', 'wb'), 
            protocol=4)'''
...
run_training_params = {'dataset': 'textures',
                             'dataset_params': {'batch_size': 128, 'test_batch_size': 128, 'train_every': 2, 'test_every': 1, 'crop_dim': 40, 
                                                'path': '/mnt/c/Users/matya/Downloads/lagrange/fakelabeled_natural_commonfiltered_640000_40px.pkl', 'offset': 0.0}, 
